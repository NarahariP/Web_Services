...
public class SwaggerConfiguration {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Hari", "https://google.com", "something@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("User Info", "User Webservice", "1.0", "urn:tos",
