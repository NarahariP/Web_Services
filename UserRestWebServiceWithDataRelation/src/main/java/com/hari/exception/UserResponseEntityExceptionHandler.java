...
public class UserResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = { UserNotFoundException.class, AddressNotFoundException.class })
	public final ResponseEntity<ExceptionResource> handleUserNotFoundException(Exception ex, WebRequest request) {
